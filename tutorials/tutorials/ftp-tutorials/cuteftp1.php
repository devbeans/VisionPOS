                  ...
                  <td width="592" rowspan="4"> <table width="592">
                      <tr> 
                        <td><!-- InstanceBeginEditable name="Main Body" --> 
                          <p align="center" class="main"><span class="fineprint">This 
                            is the initial screen of CuteFTP. To start the upload 
                            process click the connect button. It is the second 
                            one from the left and is labeled with lightning bolt.</span><br>
                                            <br>
                                            <img src="../../images/cuteftp1.gif" width="492" height="344"> 
                                          </p>
                                          <table width="55%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td width="31%"><div align="center"><a href="http://www.webhostgalaxy.com/tutorials/index.htm" class="dark-blue-links">Back</a></div></td>
                                              <td width="29%"><div align="center"><a href="http://www.webhostgalaxy.com/tutorials/ftp-tutorials/cuteftp2.php" class="dark-blue-links">Next</a></div></td>
                                              <td width="40%"><div align="center"><a href="http://www.webhostgalaxy.com/tutorials/index.php" class="dark-blue-links">Main 
                                  Menu</a></div></td>
                                            </tr>
                                          </table>
