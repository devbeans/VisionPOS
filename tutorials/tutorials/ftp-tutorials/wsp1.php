                  ...
                  <td width="592" rowspan="4"> <table width="592">
                      <tr> 
                        <td><!-- InstanceBeginEditable name="Main Body" --> 
                                          <p align="center" class="fineprint">This 
                                            is the initial screen of WS_FTP LE. 
                                            The program includes the settings 
                                            for several anonymous FTP sites. One 
                                            of these accounts will display when 
                                            the program is launched. </p>
                                          <p align="center" class="fineprint">The 
                                            settings for accounts are stored in 
                                            profiles. To create a new profile 
                                            for a hosting account click the 'New' 
                                            button in the upper right of the dialogue 
                                            box.<br>
                                            <br>
                                            <img src="../../images/wsftp1.gif" width="546" height="282"></p>
                                          <table width="55%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td><div align="center"><a href="http://www.webhostgalaxy.com/tutorials/ftp-tutorials/menu.php" class="dark-blue-links">Back</a></div></td>
                                              <td><div align="center"><a href="http://www.webhostgalaxy.com/tutorials/ftp-tutorials/wsp2.php" class="dark-blue-links">Next</a></div></td>
