...
menu10[0]='<a href="https://cp.hostnine.com" target="_blank">Reseller Central</a>'
menu10[1]='<a href="https://webhostgalaxy.com/cpanel" target="_blank">Whg Cpanel</a>'
menu10[2]='<a href="https://gowhg.com/cpanel" target="_blank">GoWhg Cpanel</a>'
menu10[3]='<a href="/ls/setup" target="_blank">Live Support Admin</a>'
menu10[4]='<a href="/links/admin" target="_blank">Links Admin Login</a>'
menu10[5]='<a href="http://www.resellerclub.com/login/" target="_blank">Directi - Domain Names</a>'
menu10[6]='<a href="/mainp/wp-admin/index.php" target=_blank">WordPress Admin</a>'
menu10[7]='<a href="https://webhostgalaxy.info/cpanel" target="_blank">Whg Info Cpanel</a>'
menu10[8]='<a href="browser.php">Internal Browser</a>'

var menu11=new Array()
menu11[0]='<a href="http://webhostgalaxy.info/stats/index.php" target="_blank">Server Status</a>'
menu11[1]='<a href="https://doughesseltine.freshbooks.com/" target="_blank">Time Sheets - FreshBooks</a>'
menu11[2]='<a href="http://gowhg.com/WHGforum/" target="_blank">Whg Forum</a>'
menu11[3]='<a href="/mainp/index.php" target="_blank">WordPress Front</a>'
menu11[4]='<a href="/ls/" target="_blank">Live Support Operator</a>'
menu11[4]='<a href="browser.php">Internal Browser</a>'
