...

{
	...
	*/
	...
	{
		return $this->ci->session->userdata('DX_store_id');
	}
...

	{
		...
		//DOUG HESSELTINE - Added to make login NOT case sensitive.		
	...
	function register($username, $password, $email, $store)
	...
	{		
		...
		$new_user = array(			
			...
			'username'				=> strtolower($username),	//DOUG HESSELTINE - modified to set to lowercase		
...

		{
...

			{
				...
				//$this->_email($from, $from, $subject, $message);  //original modified from below to prevent auto activation.  FINISH THIS LATER - DOUG - REVERESED
